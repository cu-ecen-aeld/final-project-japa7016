...
CONFLINES=(
    ...
    'ENABLE_SPI_BUS = "1"'
    'IMAGE_INSTALL:append = "i2c-tools linux-firmware-rpidistro-bcm43430 v4l-utils python3 ntp wpa-supplicant spitools ifupdown wireless-regdb-static avahi-daemon"'
    ...
    'RPI_KERNEL_DEVICETREE:append = " epd-overlay"'    
)
